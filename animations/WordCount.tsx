...
export const WordCount: React.FC<WordCountProps> = ({ content = '' }) => {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-[rgba(76,68,212,0.08)] px-2.5 py-1 text-[11px] font-bold uppercase tracking-wider text-[#4c44d4]">
